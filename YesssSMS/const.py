...
HELP = {'to_help': 'Recipient phone number in the format: +436601234567',
        ...
        'login': 'Your phone number (eg. 06501234567), used to login at yesss.at',
        'password': """Your password, it\'s not recommended to use this. Use a config-file instead (see: -c, --configfile).""",
